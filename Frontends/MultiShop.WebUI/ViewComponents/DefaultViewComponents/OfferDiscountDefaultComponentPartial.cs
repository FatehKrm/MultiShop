...
namespace MultiShop.WebUI.ViewComponents.DefaultViewComponents
{
    public class OfferDiscountDefaultComponentPartial : ViewComponent
    {
        ...
        public OfferDiscountDefaultComponentPartial(IHttpClientFactory httpClientFactory)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            if (responseMessage.IsSuccessStatusCode)
            {
                ...
                var values = JsonConvert.DeserializeObject<List<ResultOfferDiscountDto>>(jasonData); // gelen string veriyi de deserialize edip CategoryDto tipine dönüştürecek
