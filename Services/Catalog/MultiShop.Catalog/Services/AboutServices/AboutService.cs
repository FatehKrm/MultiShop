...
namespace MultiShop.Catalog.Services.AboutServices
{
    public class AboutService : IAboutService
    {
        ...
        {
            var value = _mapper
                .Map<About>(createAboutDto);
            await _AboutCollection.InsertOneAsync(value);
        }

        public async Task DeleteAboutAsync(string id)
        {
            await _AboutCollection
                 .DeleteOneAsync(x => x.AbooutId == id);
        }
        ...
        {
            var values = await _AboutCollection  // About Collection sql server da tablo gibi düşünülebilir
                .Find<About>(x => x.AbooutId == id)
                .FirstOrDefaultAsync();
        ...
        public async Task UpdateAboutAsync(UpdateAboutDto updateAboutDto)
        {
            ...
            await _AboutCollection
                .FindOneAndReplaceAsync(x => x.AbooutId == updateAboutDto.AbooutId, values);
        }
    }
}
