...
namespace MultiShop.Catalog.Services.ProductImageServices
{
    public class ProductImageService : IProductImageService
    {
        ...
        {
           var values = _mapper
                .Map<ProductImage>(createProductImageDto);
        ...
        public async Task DeleteProductImageAsync(string id)
        {
            await _productImageCollection
                .DeleteOneAsync(x => x.ProductImageId == id);
        }
        ...
        {
            var values = await _productImageCollection
                .Find<ProductImage>(x => x.ProductImageId == id)
                .FirstOrDefaultAsync();
        ...
        public async Task UpdateProductImageAsync(UpdateProductImageDto updateProductImageDto)
        {
            ...
            await _productImageCollection
                .FindOneAndReplaceAsync(x => x.ProductImageId == updateProductImageDto.ProductImageId, values);
        }
    }
}
