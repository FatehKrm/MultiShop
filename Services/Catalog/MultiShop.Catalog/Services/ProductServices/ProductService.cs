...
namespace MultiShop.Catalog.Services.ProductServices
{
    public class ProductService : IProductService
    {
        ...
        public ProductService(IMapper mapper, IDatabaseSettings _databaseSetting)
        {
        ...
        public async Task DeleteProductAsync(string id)
        {
            await _productCollection
                .DeleteOneAsync(x => x.ProductId == id);
        }
        ...
        public async Task<List<ResultProductsWithCategoryDto>> GetProductsWithCategoryByCategoryIdAsync(string categoryId)
        {
            ...
            return _mapper.Map<List<ResultProductsWithCategoryDto>>(values); // ürünleri kategorilerine göre listelemek için sorgu kodu.    
        }
        ...
        public async Task UpdateProductAsync(UpdateProductDto updateProductDto)
        {
            ...
            await _productCollection
                .FindOneAndReplaceAsync(x => x.ProductId == updateProductDto.ProductId, values);
        }
    }
}
