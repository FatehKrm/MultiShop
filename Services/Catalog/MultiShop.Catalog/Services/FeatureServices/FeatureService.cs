...
namespace MultiShop.Catalog.Services.FeatureServices
{
    public class FeatureService : IFeatureService
    {
        ...
        {
            var values = await _FeatureCollection
                .Find(x => true)
                .ToListAsync();
        ...
        {
            var values = await _FeatureCollection  // Feature Collection sql server da tablo gibi düşünülebilir
                .Find<Feature>(x => x.FeatureId == id)
                .FirstOrDefaultAsync();
        ...
        public async Task UpdateFeatureAsync(UpdateFeatureDto updateFeatureDto)
        {
            ...
            await _FeatureCollection
                .FindOneAndReplaceAsync(x => x.FeatureId == updateFeatureDto.FeatureId, values);
        }
    }
}
